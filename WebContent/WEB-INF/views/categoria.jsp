...
<head>
<meta charset=UTF-8>
<title>Categoria Vehiculos</title>
<meta name="viewport"
...
<body>
				...
				<div class="modal-body">
					<div class="form-group">
						<div class="row">
							...
							id="save_categoria" placeholder="Ingrese Categoria"></div>
							<div class="col-md-2"><input class="btn btn-success" type="button" value="validar"
									id="btn_validar"></div>
						</div>
						<hr>
						<input type="text" class="form-control" id="save_precio"
									placeholder="Ingrese precio">
						<hr>
						<input type="text" class="form-control" id="save_estado"
									placeholder="Ingrese estado">
						<hr>
						<input type="text" class="form-control" id="save_idcategoria" disabled="disabled">
	...
	<script type="text/javascript" src="resources/js/categoriaScript.js"></script>
</body>
