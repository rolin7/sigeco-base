...
<title>Sistema Gestión Cochera</title>
<!-- Normalize CSS -->
        ...
        <div class="NavLateral-content full-width">
            ...
            <div class="NavLateral-Nav">
                <ul class="full-width">
                    ...
                    <li class="NavLateralDivider"></li>
                    <li>
                        <a href="#" class="NavLateral-DropDown  waves-effect waves-light"><i class="zmdi zmdi-view-web zmdi-hc-fw"></i> <i class="zmdi zmdi-chevron-down NavLateral-CaretDown"></i>CONFIGURACIÓN</a>
                        <ul class="full-width">
